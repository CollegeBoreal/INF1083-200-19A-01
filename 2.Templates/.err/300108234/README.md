...
Native stack trace:
1   0x11012224e NativeScript::reportFatalErrorBeforeShutdown(JSC::ExecState*, JSC::Exception*, bool)
2   0x11015e878 NativeScript::FFICallback<NativeScript::ObjCMethodCallback>::ffiClosureCallback(ffi_cif*, void*, void**, void*)
3   0x110b053d6 ffi_closure_unix64_inner
4   0x110b05dfa ffi_closure_unix64
5   0x116331eae -[CALayer layoutSublayers]
6   0x116336b88 CA::Layer::layout_if_needed(CA::Transaction*)
7   0x116342ee4 CA::Layer::layout_and_display_if_needed(CA::Transaction*)
8   0x1162b23aa CA::Context::commit_transaction(CA::Transaction*)
9   0x1162e9584 CA::Transaction::commit()
10  0x11490bccb __34-[UIApplication _firstCommitBlock]_block_invoke_2
11  0x113406aec __CFRUNLOOP_IS_CALLING_OUT_TO_A_BLOCK__
12  0x1134062b0 __CFRunLoopDoBlocks
13  0x113400b34 __CFRunLoopRun
14  0x113400302 CFRunLoopRunSpecific
15  0x11a4962fe GSEventRunModal
16  0x1148f2ba2 UIApplicationMain
17  0x110b05c3d ffi_call_unix64
18  0x12a56e410
